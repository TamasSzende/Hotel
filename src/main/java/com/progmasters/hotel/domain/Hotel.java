...
public class Hotel {
	...
	public Hotel(String name, String postalCode, String city, String streetAddress, HotelType hotelType, Integer hotelCapacity, List<Room> rooms, String hotelImageUrl, String description, List<HotelFeatureType> hotelFeatures) {
	this.name = name;
	...
	public void actualizeCapacity() {
		this.hotelCapacity = 0;
		for (Room room : this.rooms) {
			hotelCapacity += room.getNumberOfBeds();
		}
	}
